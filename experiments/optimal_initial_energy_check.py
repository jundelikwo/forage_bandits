...
def main(cfg: DictConfig) -> None:
    ...
    for init_energy in init_energy_range:
        ...
        regret, regret_std, lifetime, lifetime_std = run_simulation(cfg, init_energy, "egree", False, eta=0, custom_exploration_function=no_energy_custom_exploration_factor)
        ...
        regret, regret_std, lifetime, lifetime_std = run_simulation(cfg, init_energy, "egree", True, eta=1, custom_exploration_function=linear_custom_exploration_factor)
        ...
        print("  UCB (no energy)...")
        regret, regret_std, lifetime, lifetime_std = run_simulation(cfg, init_energy, "ucb", False, eta=0, custom_exploration_function=no_energy_custom_exploration_factor)
        ...
        print("  UCB (energy)...")
        regret, regret_std, lifetime, lifetime_std = run_simulation(cfg, init_energy, "ucb", True, eta=1, custom_exploration_function=linear_custom_exploration_factor)
        ...
        print("  TS (no energy)...")
        regret, regret_std, lifetime, lifetime_std = run_simulation(cfg, init_energy, "ts", False, eta=0, custom_exploration_function=no_energy_custom_exploration_factor)
        ...
        print("  TS (energy)...")
        regret, regret_std, lifetime, lifetime_std = run_simulation(cfg, init_energy, "ts", True, eta=1, custom_exploration_function=linear_custom_exploration_factor)
    ...
    plt.tight_layout()
    plt.savefig(output_dir / f"optimal_initial_energy_check_{cfg.env.name}_{cfg.env.n_arms}.png", dpi=300, bbox_inches='tight')
    plt.close()
    
    # Save results
    with open(output_dir / f"optimal_initial_energy_check_{cfg.env.name}_{cfg.env.n_arms}.json", "w") as f:
        json.dump(results, f, indent=2)
    
    print(f"\nResults saved to experiments/results/optimal_initial_energy_check_{cfg.env.name}_{cfg.env.n_arms}.json")
    print(f"Plot saved to experiments/results/optimal_initial_energy_check_{cfg.env.name}_{cfg.env.n_arms}.png")
